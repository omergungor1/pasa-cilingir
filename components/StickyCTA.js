...
export default function StickyCTA() {
  ...
  return (
    <div
      className="fixed bottom-0 left-0 right-0 z-50 flex items-center gap-2 p-3 md:bottom-4 md:left-auto md:right-4 md:max-w-sm md:flex-col md:gap-3 md:p-4"
      role="group"
    ...
    >
      ...
      <a
        ...
        className="flex h-14 w-14 shrink-0 items-center justify-center rounded-xl bg-[#25D366] shadow-lg transition hover:bg-[#20bd5a] md:order-2 md:h-auto md:w-full md:gap-2 md:rounded-xl md:px-6 md:py-4"
      ...
      >
        ...
        <span className="hidden font-bold text-white md:inline">WhatsApp</span>
      </a>
    </div>
  );
}
